...
function WaitingPage({ onLogout }: WaitingPageProps) {
  return (
      ...
      <div className="max-w-sm w-full space-y-6">
        ...
        <div className="bg-slate-800 p-8 rounded-xl shadow-2xl border border-slate-700 space-y-6">
          <div className="space-y-1">
            <h2 className="text-lg font-semibold text-yellow-400">Awaiting Approval</h2>
            <p className="text-slate-400 text-sm">
              Your account is pending review. You'll be able to access the app once an admin approves your request.
            </p>
          </div>
